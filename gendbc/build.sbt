...
// this file. This file is loaded by com.databricks.training.gendbc.BuildInfo.
...
installFiles := {
  ...
  def doUnixLikeInstall() = {
    val (script, _) = installFiles(
      scriptTemplate = new File((scriptDir / "gendbc.sh").toString),
      scriptDestName = "gendbc"
    )
  ...
  def doWindowsInstall() = {
    installFiles(
      scriptTemplate = new File((scriptDir / "gendbc.bat").toString),
      scriptDestName = "gendbc.bat"
    )
  }
