// Databricks notebook source exported at Tue, 17 May 2016 21:40:24 UTC
...
// MAGIC 
// MAGIC You can see the hourly dump files here: https://dumps.wikimedia.org/other/pagecounts-raw/

// COMMAND ----------

// MAGIC %md For example, [here](https://dumps.wikimedia.org/other/pagecounts-raw/2016/2016-03/) is the hourly dumps webpage for March 2016:
...
// MAGIC %md Consider opening the [DataFrame API docs](https://spark.apache.org/docs/latest/api/scala/index.html#org.apache.spark.sql.DataFrame) in a new tab to keep it handy as a reference. 
// MAGIC 
...
// MAGIC 
// MAGIC You can learn more expression operators on columns (like !==, &&, <=, etc) in the [API docs for Column](https://spark.apache.org/docs/latest/api/scala/index.html#org.apache.spark.sql.Column).
...
// MAGIC 
// MAGIC 
// MAGIC Source: https://en.wikipedia.org/wiki/Wikipedia:Namespace
...
// MAGIC 
// MAGIC Source: https://en.wikipedia.org/wiki/User:Jimbo_Wales
...
// MAGIC 
// MAGIC Source: https://en.wikipedia.org/wiki/Jimmy_Wales
...
// MAGIC 
// MAGIC Source: https://en.wikipedia.org/wiki/File:Jimmy_Wales_July_2010.jpg
...
pagecountsEnWikipediaArticlesOnlyDF.show(2)
...
pagecountsEnWikipediaArticlesOnlyDF.show(5)
